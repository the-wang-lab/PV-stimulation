function NaiveBayesClassifierGpuWithCrossValRiseDownAllSTD0p2(paths,filenames,mazeSess,upDown,task,onlyRun)
% use a subpopulation of neurons to predit time or distance
    ...
    paramC.trialLenT = ceil(4/paramC.timeBin1)*paramC.timeBin1; %sec % changed on 1/10/2025 from "ceil(5/paramC.timeBin1)*paramC.timeBin1; "
