function barPlotWithStat5(ind,x,y,xdata,ydata,ylab,tit,rankXY,fn,pathAnal,colorSel,labels,xl)
    ...
    set(h,'MarkerSize',7,'LineWidth',1,'Color',[0.7 0.7 0.7]);
    h = plot([1.1 2.1],[xdata' ydata'],'k.-');
    set(h,'MarkerSize',6,'LineWidth',0.1,'Color',[0.7 0.7 0.7]);
