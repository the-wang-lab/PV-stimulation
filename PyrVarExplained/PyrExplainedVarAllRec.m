function PyrExplainedVarAllRec(taskSel)
...
%% accumulate over all the recordings
    ...
    if(exist([pathAnal1 'varPyrAllRecCueRew.mat']))
        load([pathAnal1 'varPyrAllRecCueRew.mat']);
    end
    ...
    save([pathAnal1 'expVarPyrAllRec.mat'],'ExpVarAllPyr','PyrRiseExpVar','PyrDownExpVar','PyrOtherExpVar',...
