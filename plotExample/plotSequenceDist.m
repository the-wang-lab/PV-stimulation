...
% behavioral features
    ...
    maxAvgFilteredArray = max(avgFilteredSpikeArrayRunGood');
    avgFilteredSpikeArrayRunGood = avgFilteredSpikeArrayRunGood./...
        repmat(maxAvgFilteredArray',1,size(avgFilteredSpikeArrayRunGood,2));
    ...
    maxAvgFilteredArray = max(avgFilteredSpikeArrayRunBad');
    avgFilteredSpikeArrayRunBad = avgFilteredSpikeArrayRunBad./...
        repmat(maxAvgFilteredArray',1,size(avgFilteredSpikeArrayRunBad,2));
