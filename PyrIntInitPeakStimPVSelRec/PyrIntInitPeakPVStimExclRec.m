function PyrIntInitPeakPVStimExclRec(methodKMean)
% compare Pyramidal neurons and PV interneurons on their initial peak
% excluding the recordings defined in GlobalConstFq
    
    pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalPVStimALSelRec\'];
    pathAnal = ['Z:\Yingxue\Draft\PV\PyramidalPVStimALSelRec\' num2str(methodKMean) '\'];
    if(exist([pathAnal 'initPeakPyrAllRecStim.mat']))
        load([pathAnal 'initPeakPyrAllRecStim.mat']);
    end
    if(exist([pathAnal 'initPeakPyrAllRecStim_km2.mat']))
        load([pathAnal 'initPeakPyrAllRecStim_km2.mat']);
    end
...
%     if(~exist('PyrRise'))
    ...
    %     idx1 = find(ratio0to1BefRunOrd >= 0.5,1,'last');
        ...
        for i = 1: 2
            ...
            for j = 1:length(pulseMethod{i})
                ...
                for m = 1:length(stimLocs)  
                    ...
                    %% pyramidal neurons theta modulation (added on 7/14/2022)
                    [PyrStim1.thetaMod{cond},PyrStim1.thetaModStim{cond},PyrStim1.thetaModStimCtrl{cond}] = accumThetaMod(modPyr1AL,ind);
                    PyrStim1.thetaModStatNonStimVsStim{cond} = thetaModStat(PyrStim1.thetaMod{cond},PyrStim1.thetaModStim{cond});
                    PyrStim1.thetaModStatNonStimVsStimCtrl{cond} = thetaModStat(PyrStim1.thetaMod{cond},PyrStim1.thetaModStimCtrl{cond});
                    ...
                    %% pyramidal neurons fields theta modulation (added on 7/14/2022)
                    [PyrStim1.thetaModField{cond},PyrStim1.thetaModStimField{cond},PyrStim1.thetaModStimCtrlField{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrStim1.FRProfile1{cond}.indField);
                    PyrStim1.thetaModFieldStatNonStimVsStim{cond} = thetaModStat(PyrStim1.thetaModField{cond},PyrStim1.thetaModStimField{cond});
                    PyrStim1.thetaModFieldStatNonStimVsStimCtrl{cond} = thetaModStat(PyrStim1.thetaModField{cond},PyrStim1.thetaModStimCtrlField{cond});
                    ...
                    %% pyramidal rise and down neurons fields theta modulation (added on 7/14/2022)
                    [PyrRise.thetaMod{cond},PyrRise.thetaModStim{cond},PyrRise.thetaModStimCtrl{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrStim1.FRProfile1{cond}.indPyrRise);
                    [PyrDown.thetaMod{cond},PyrDown.thetaModStim{cond},PyrDown.thetaModStimCtrl{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrStim1.FRProfile1{cond}.indPyrDown);
                    [PyrOther.thetaMod{cond},PyrOther.thetaModStim{cond},PyrOther.thetaModStimCtrl{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrStim1.FRProfile1{cond}.indPyrOther);
                    
                    PyrRise.thetaModStatNonStimVsStim{cond} = thetaModStat(PyrRise.thetaMod{cond},PyrRise.thetaModStim{cond});
                    PyrRise.thetaModStatNonStimVsStimCtrl{cond} = thetaModStat(PyrRise.thetaMod{cond},PyrRise.thetaModStimCtrl{cond});
                    PyrDown.thetaModStatNonStimVsStim{cond} = thetaModStat(PyrDown.thetaMod{cond},PyrDown.thetaModStim{cond});
                    PyrDown.thetaModStatNonStimVsStimCtrl{cond} = thetaModStat(PyrDown.thetaMod{cond},PyrDown.thetaModStimCtrl{cond});
                    PyrOther.thetaModStatNonStimVsStim{cond} = thetaModStat(PyrOther.thetaMod{cond},PyrOther.thetaModStim{cond});
                    PyrOther.thetaModStatNonStimVsStimCtrl{cond} = thetaModStat(PyrOther.thetaMod{cond},PyrOther.thetaModStimCtrl{cond});
                    ...
                    %% pyramidal rise and down neurons fields theta modulation (added on 7/14/2022)
                    [PyrRise.thetaModField{cond},PyrRise.thetaModStimField{cond},PyrRise.thetaModStimCtrlField{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrRise.isNeuWithFieldAligned{cond}.idxRise);
                    [PyrDown.thetaModField{cond},PyrDown.thetaModStimField{cond},PyrDown.thetaModStimCtrlField{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrDown.isNeuWithFieldAligned{cond}.idxDown);
                    [PyrOther.thetaModField{cond},PyrOther.thetaModStimField{cond},PyrOther.thetaModStimCtrlField{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrOther.isNeuWithFieldAligned{cond}.idxOther);
                    
                    PyrRise.thetaModFieldStatNonStimVsStim{cond} = thetaModStat(PyrRise.thetaModField{cond},PyrRise.thetaModStimField{cond});
                    PyrRise.thetaModFieldStatNonStimVsStimCtrl{cond} = thetaModStat(PyrRise.thetaModField{cond},PyrRise.thetaModStimCtrlField{cond});
                    PyrDown.thetaModFieldStatNonStimVsStim{cond} = thetaModStat(PyrDown.thetaModField{cond},PyrDown.thetaModStimField{cond});
                    PyrDown.thetaModFieldStatNonStimVsStimCtrl{cond} = thetaModStat(PyrDown.thetaModField{cond},PyrDown.thetaModStimCtrlField{cond});
                    PyrOther.thetaModFieldStatNonStimVsStim{cond} = thetaModStat(PyrOther.thetaModField{cond},PyrOther.thetaModStimField{cond});
                    PyrOther.thetaModFieldStatNonStimVsStimCtrl{cond} = thetaModStat(PyrOther.thetaModField{cond},PyrOther.thetaModStimCtrlField{cond});
                    
                    %% pyramidal rise and down neurons fields comb theta modulation (added on 7/14/2022)
                    [PyrRise.thetaModFieldComb{cond},PyrRise.thetaModStimFieldComb{cond},PyrRise.thetaModStimCtrlFieldComb{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrRise.isNeuWithFieldAligned{cond}.idxRiseComb);
                    [PyrDown.thetaModFieldComb{cond},PyrDown.thetaModStimFieldComb{cond},PyrDown.thetaModStimCtrlFieldComb{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrDown.isNeuWithFieldAligned{cond}.idxDownComb);
                    [PyrOther.thetaModFieldComb{cond},PyrOther.thetaModStimFieldComb{cond},PyrOther.thetaModStimCtrlFieldComb{cond}] = ...
                        accumThetaMod(modPyr1AL,PyrOther.isNeuWithFieldAligned{cond}.idxOtherComb);
                    
                    PyrRise.thetaModFieldCombStatNonStimVsStim{cond} = thetaModStat(PyrRise.thetaModFieldComb{cond},PyrRise.thetaModStimFieldComb{cond});
                    PyrRise.thetaModFieldCombStatNonStimVsStimCtrl{cond} = thetaModStat(PyrRise.thetaModFieldComb{cond},PyrRise.thetaModStimCtrlFieldComb{cond});
                    PyrDown.thetaModFieldCombStatNonStimVsStim{cond} = thetaModStat(PyrDown.thetaModFieldComb{cond},PyrDown.thetaModStimFieldComb{cond});
                    PyrDown.thetaModFieldCombStatNonStimVsStimCtrl{cond} = thetaModStat(PyrDown.thetaModFieldComb{cond},PyrDown.thetaModStimCtrlFieldComb{cond});
                    PyrOther.thetaModFieldCombStatNonStimVsStim{cond} = thetaModStat(PyrOther.thetaModFieldComb{cond},PyrOther.thetaModStimFieldComb{cond});
                    PyrOther.thetaModFieldCombStatNonStimVsStimCtrl{cond} = thetaModStat(PyrOther.thetaModFieldComb{cond},PyrOther.thetaModStimCtrlFieldComb{cond});
        ...
        save([pathAnal0 'initPeakPyrIntAllRecStim.mat'],'PyrStim1','PyrRise','PyrDown','PyrOther'); 
%     end
    ...
    plotThetaModStimStats(pathAnal0,PyrRise.thetaModFieldCombStatNonStimVsStim,[{'Nonstim'} {'Stim'}],'PyrRise');
    close all;
    ...
    plotThetaModStimStats(pathAnal0,PyrDown.thetaModFieldCombStatNonStimVsStim,[{'Nonstim'} {'Stim'}],'PyrDown');
    close all;
    ...
    plotThetaModStimStats(pathAnal0,PyrOther.thetaModFieldCombStatNonStimVsStim,[{'Nonstim'} {'Stim'}],'PyrOther');
    close all;
end
