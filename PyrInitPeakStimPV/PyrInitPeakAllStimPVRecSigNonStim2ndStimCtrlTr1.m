function PyrInitPeakAllStimPVRecSigNonStim2ndStimCtrlTr1(methodKMean)
%% only consider stimulation recordings
    ...
    pathAnal = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSig1\2\'];
    ...
    if(~exist('modPyr1AL'))
        ...
        modPyr1AL = accumPyr3NoStim2ndStimCtrl1(listRecordingsActiveLickPath,...
