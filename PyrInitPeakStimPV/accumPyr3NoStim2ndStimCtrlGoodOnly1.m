function modPyr1 = accumPyr3NoStim2ndStimCtrlGoodOnly1(paths,filenames,mazeSess,autoCorrPyrAll,...
    ...
    for i = 1:numRec
        ...
        for n = 1:length(pulseMeth)
            ...
            trialNoStimCtrlGood = intersect(trialNoStimCtrl,indGood);
            ...
            for m = 1:length(indNeu1)
                ...
                filteredSpikeArrayTmp = filteredSpikeArrayRunOnSet{indNeu1(m)}(trialNoStimCtrlGood,:);
