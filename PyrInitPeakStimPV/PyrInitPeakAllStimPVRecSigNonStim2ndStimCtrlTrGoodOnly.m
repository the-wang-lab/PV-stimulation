function PyrInitPeakAllStimPVRecSigNonStim2ndStimCtrlTrGoodOnly(methodKMean)
%% only consider stimulation recordings
    ...
    pathAnal = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSigGoodOnly\2\'];
    ...
    if(~exist('modPyr1AL'))
        ...
        modPyr1AL = accumPyr3NoStim2ndStimCtrlGoodOnly(listRecordingsActiveLickPath,...
