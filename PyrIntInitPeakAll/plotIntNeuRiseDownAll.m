function plotIntNeuRiseDownAll(pathAnal,timeStepRun,...
    ...
    for i = 1:max(InitAll.idxC2Int)
        ...
        plotIndFRProfileProvOrder(timeStepRun,...
                InitAll.avgFRProfileNormBadInt(idxCTmp,:),['FR (Hz) Bad  C' num2str(i)],...
        ...
        plotAvgFRProfileCmp(timeStepRun,...
                ...
                InitAll.avgFRProfileBadInt(IntRise.idxRise{i},:),...
...
%                 InitAll.avgFRProfileBad(IntDown.idxDown{i},:),...
...
%                 pathAnal,[],xlabels)
        ...
        plotAvgFRProfileCmp(timeStepRun,...
                ...
                InitAll.avgFRProfileNormBadInt(IntRise.idxRise{i},:),...
