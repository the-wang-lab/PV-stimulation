function plotPyrNeuRiseDownFieldAll(pathAnal,timeStepRun,InitAll,...
    ...
    indMax1 = mean(InitAll.avgFRProfileNorm(indGoodTmp,FRProfileMean.indFRBefRun)');
    indMax2 = mean(InitAll.avgFRProfileNorm(indGoodTmp,FRProfileMean.indFR0to1)');
    ...
    plotAvgFRProfileCmp(timeStepRun,...
            ...
            InitAll.avgFRProfileBad(isNeuWithFieldAligned.idxRise,:),...
    ...
    plotAvgFRProfileCmp(timeStepRun,...
            ...
            InitAll.avgFRProfileBad(isNeuWithFieldAligned.idxDown,:),...
    ...
    plotAvgFRProfileCmp(timeStepRun,...
            ...
            InitAll.avgFRProfileBad(isNeuWithFieldAligned.idxOther,:),...
    ...
    plotAvgFRProfileCmp(timeStepRun,...
            ...
            InitAll.avgFRProfileNormBad(isNeuWithFieldAligned.idxRise,:),...
    ...
    plotAvgFRProfileCmp(timeStepRun,...
            ...
            InitAll.avgFRProfileNormBad(isNeuWithFieldAligned.idxDown,:),...
    ...
    plotAvgFRProfileCmp(timeStepRun,...
            ...
            InitAll.avgFRProfileNormBad(isNeuWithFieldAligned.idxOther,:),...
