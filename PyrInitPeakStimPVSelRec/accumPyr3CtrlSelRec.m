function modPyr1 = accumPyr3CtrlSelRec(paths,filenames,mazeSess,autoCorrPyrAll,...
            nNeuWithFieldAligned,isNeuWithFieldAligned,...
            anmNoInact,anmNoAct,minFR,maxFR,task,sampleFq,intervalT,excludeRec)
    numRec = size(paths,1);
