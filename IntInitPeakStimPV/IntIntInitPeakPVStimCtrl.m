function IntIntInitPeakPVStimCtrl(methodKMean)
...
%% select neuron that do not have significant difference in baseline firing rate between ctrl and stim ctrl trials
    ...
    pathAnal0 = ['Z:\Yingxue\Draft\PV\InterneuronPVStimALCtrl\'];
...
%     ind = ~ismember(modInt1AL.indRec, recExcl);
    ...
    IntStim.idxC2Int = modInt1AL.idxC2;
    ...
    if(flagIntStim == 0)
        ...
        %% interneurons separated by clusters and stim conditions
