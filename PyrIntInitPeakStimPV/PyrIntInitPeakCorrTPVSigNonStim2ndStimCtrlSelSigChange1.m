function PyrIntInitPeakCorrTPVSigNonStim2ndStimCtrlSelSigChange1(methodKMean,p,pdrift)
%% activity correlation of PyrRise and PyrDown neurons before and during stimulation

    pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSelSigP' num2str(p) '-NoDriftRec\'];
