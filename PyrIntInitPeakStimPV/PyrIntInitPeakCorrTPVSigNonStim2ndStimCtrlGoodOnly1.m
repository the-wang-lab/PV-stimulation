function PyrIntInitPeakCorrTPVSigNonStim2ndStimCtrlGoodOnly1(methodKMean,stimCtrlCond)
...
% stimCtrlCond = 2, only include sessions where 2 stim ctrl are followed by one stim trial
    ...
    if(exist([pathAnal0 'initPeakPyrIntCorrTAllRecStimSigNoStim2ndStimCtrlTrGoodOnly.mat']))
        load([pathAnal0 'initPeakPyrIntCorrTAllRecStimSigNoStim2ndStimCtrlTrGoodOnly.mat']);
    end
    ...
    save([pathAnal0 'initPeakPyrIntCorrTAllRecStimSigNoStim2ndStimCtrlTrGoodOnly.mat'],'PyrStimT','PyrRise1','PyrDown1','PyrOther1'); 
