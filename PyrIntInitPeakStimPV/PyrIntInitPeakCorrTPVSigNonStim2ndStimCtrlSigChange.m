function PyrIntInitPeakCorrTPVSigNonStim2ndStimCtrlSigChange(methodKMean,p)
%% activity correlation of PyrRise and PyrDown neurons before and during stimulation
    ...
    PyrStimT.indNeuSel = 1:length(modPyr1AL.actOrInact);
    PyrStimT.actOrInact = modPyr1AL.actOrInact; % is it activation or inactivation
    PyrStimT.indRec = modPyr1AL.indRec; % recording index
    PyrStimT.indNeu = modPyr1AL.indNeu; % neuron indices trials
    PyrStimT.pulseMeth = modPyr1AL.pulseMeth; % pulse method
    PyrStimT.stimLoc = modPyr1AL.stimLoc; % stimulation location on the track
    PyrStimT.meanNZNonStim = modPyr1AL.meanNZNonStim;
    PyrStimT.meanNZStim = modPyr1AL.meanNZStim;
    PyrStimT.meanNZStimCtrl = modPyr1AL.meanNZStimCtrl;
    PyrStimT.meanNZStimNonStim = modPyr1AL.meanNZStimNonStim;
