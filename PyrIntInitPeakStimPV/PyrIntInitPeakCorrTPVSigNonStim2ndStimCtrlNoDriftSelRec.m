function PyrIntInitPeakCorrTPVSigNonStim2ndStimCtrlNoDriftSelRec(methodKMean,pdrift)
%% activity correlation of PyrRise and PyrDown neurons before and during stimulation
    ...
    for cond = 1:length(PyrStim1.FRProfile1)
        ...
        if(isempty(PyrStimT.meanCorrTNZ{cond}.NonStimField) || ...
            ...
            %% added on 11/4/2024, using one-way ANOVA test
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimField = 1;
            PyrStimT.meanCorrTNZ{cond}.pAN1StimVsStimCtrlField = 1;
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimNonStimField = 1;
        else
            ...
            %% added on 11/4/2024, using one-way ANOVA test
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimField = ...
                anova1([PyrStimT.meanCorrTNZ{cond}.NonStimField',...
                        PyrStimT.meanCorrTNZ{cond}.StimField']);
            PyrStimT.meanCorrTNZ{cond}.pAN1StimVsStimCtrlField = ...
                anova1([PyrStimT.meanCorrTNZ{cond}.StimField',...
                        PyrStimT.meanCorrTNZ{cond}.StimCtrlField']);
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimNonStimField = ...
                anova1([PyrStimT.meanCorrTNZ{cond}.NonStimField',...
                        PyrStimT.meanCorrTNZ{cond}.StimNonStimField']);
            close all;
        end
        ...
        if(isempty(PyrStimT.meanCorrTNZ{cond}.NonStimFieldComb) || ...
            ...
            %% added on 11/4/2024, using one-way ANOVA test
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimFieldComb = 1;
            PyrStimT.meanCorrTNZ{cond}.pAN1StimVsStimCtrlFieldComb = 1;
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimNonStimFieldComb = 1;
            %%
            ...
            %% added on 11/4/2024, using one-way ANOVA test
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimFieldComb = ...
                anova1([PyrStimT.meanCorrTNZ{cond}.NonStimFieldComb',...
                        PyrStimT.meanCorrTNZ{cond}.StimFieldComb']);
            PyrStimT.meanCorrTNZ{cond}.pAN1StimVsStimCtrlFieldComb = ...
                anova1([PyrStimT.meanCorrTNZ{cond}.StimFieldComb',...
                        PyrStimT.meanCorrTNZ{cond}.StimCtrlFieldComb']);
            PyrStimT.meanCorrTNZ{cond}.pAN1NonStimVsStimNonStimFieldComb = ...
                anova1([PyrStimT.meanCorrTNZ{cond}.NonStimFieldComb',...
                        PyrStimT.meanCorrTNZ{cond}.StimNonStimFieldComb']);
            close all;
            %%
