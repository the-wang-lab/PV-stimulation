function PyrIntInitPeakPVStimNonStim2ndStimCtrlSelRec1(methodKMean,pDriftNeu)
% compare Pyramidal neurons and PV interneurons on their initial peak
    
    pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrl-SelRec\'];
    ...
    ind = modPyr1AL.pRSMeanFRNonStimVsStimCtrl0to1 >= pDriftNeu & indInclRec;
