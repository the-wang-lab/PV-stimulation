function PyrIntInitPeakPVStimNonStim2ndStimCtrlNoDriftSelRec1(methodKMean,pdrift)
% compare Pyramidal neurons and PV interneurons on their initial peak
    
    pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrl-NoDriftSelRec1\'];
...
%     end
    ...
    %%
    if(~isfield(modPyr1AL,'diffMeanCtrlStim0to1s'))
        indFRAll = find(modPyr1AL.timeStepRun >= 0.5 & modPyr1AL.timeStepRun < 1.5);
        meanCtrl = modPyr1AL.avgFRProfile(:,indFRAll);
        meanCtrl = mean(meanCtrl,2);

        meanStim = modPyr1AL.avgFRProfileStimCtrl(:,indFRAll);
        meanStim = mean(meanStim,2);

        modPyr1AL.diffMeanCtrlStim0to1s = meanCtrl'-meanStim';
        modPyr1AL.ratioCtrlStim0to1s = meanCtrl'./meanStim';
...
%     ind = modPyr1AL.indDriftRec & indInclRec & modPyr1AL.ratioCtrlStim0to1s < 10/3 & modPyr1AL.ratioCtrlStim0to1s > 3/10; 
%     ind = modPyr1AL.indDriftRec & indInclRec & modPyr1AL.ratioCtrlStim0to1s < 10/2 & modPyr1AL.ratioCtrlStim0to1s > 0.2;
    ind = modPyr1AL.indDriftRec & indInclRec & modPyr1AL.ratioCtrlStim0to1s < 10/3.3 & modPyr1AL.ratioCtrlStim0to1s > 0.33;
%     ind = modPyr1AL.indDriftRec & indInclRec & modPyr1AL.ratioCtrlStim0to1s < 10/6 & modPyr1AL.ratioCtrlStim0to1s > 0.6 ...
%         & abs(modPyr1AL.diffMeanCtrlStim0to1s) < 2;
...
%     end
    ...
    plotPyrNeuStimUpDownAlone0(pathAnal0,PyrStim1.FRProfileMean1,modPyr1AL,PyrStim,PyrStim1.FRProfile1);
    close all;
