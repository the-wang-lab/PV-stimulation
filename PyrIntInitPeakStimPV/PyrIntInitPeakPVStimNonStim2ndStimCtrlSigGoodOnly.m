function PyrIntInitPeakPVStimNonStim2ndStimCtrlSigGoodOnly(methodKMean,stimCtrlCond)
...
% stimCtrlCond = 2, only include sessions where 2 stim ctrl are followed by one stim trial
    ...
    if(stimCtrlCond == 1)
        pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSigGoodOnly\'];
