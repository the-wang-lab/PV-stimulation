function PyrIntInitPeakPVStimNonStim2ndStimCtrlSelSigChange1(methodKMean,p1,pdrift)
% compare Pyramidal neurons and PV interneurons on their initial peak
    
    pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSelSigP' num2str(p1) '-NoDriftRec\'];
