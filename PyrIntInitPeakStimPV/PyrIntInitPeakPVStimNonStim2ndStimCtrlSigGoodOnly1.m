function PyrIntInitPeakPVStimNonStim2ndStimCtrlSigGoodOnly1(methodKMean,stimCtrlCond)
...
% stimCtrlCond = 2, only include sessions where 2 stim ctrl are followed by one stim trial
    ...
    if(stimCtrlCond == 1)
        pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSigGoodOnly1\'];
        pathAnal = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSigGoodOnly1\' num2str(methodKMean) '\'];
    else
        pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSigGoodOnly12\'];
        pathAnal = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlSigGoodOnly12\' num2str(methodKMean) '\'];
    end
