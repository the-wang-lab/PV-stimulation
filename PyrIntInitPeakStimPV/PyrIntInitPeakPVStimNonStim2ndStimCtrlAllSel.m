function PyrIntInitPeakPVStimNonStim2ndStimCtrlAllSel(methodKMean)
% compare Pyramidal neurons and PV interneurons on their initial peak
    
    pathAnal0 = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlAllSel\'];
    pathAnal = ['Z:\Yingxue\Draft\PV\PyramidalStimALNonStim2ndStimCtrlAllSig\' num2str(methodKMean) '\'];
    ...
    if(exist([pathAnal0 'initPeakPyrIntAllRecStimSigNoStim2ndStimCtrlAll.mat']))
        load([pathAnal0 'initPeakPyrIntAllRecStimSigNoStim2ndStimCtrlAll.mat']);
    end
    
    if(exist([pathAnal 'initPeakPyrAllRecSigStimNoStim2ndStimCtrlAll_km' num2str(methodKMean) '.mat']))
        load([pathAnal 'initPeakPyrAllRecSigStimNoStim2ndStimCtrlAll_km' num2str(methodKMean) '.mat']);
    end
...
%     if(~exist('PyrRise'))
    ...
    %     idx1 = find(ratio0to1BefRunOrd >= 0.5,1,'last');
        ...
        save([pathAnal0 'initPeakPyrIntAllRecStimSigNoStim2ndStimCtrlAll.mat'],'PyrStim1','PyrRise','PyrDown','PyrOther','-v7.3'); 
%     end
