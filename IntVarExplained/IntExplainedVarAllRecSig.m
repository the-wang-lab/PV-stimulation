function IntExplainedVarAllRecSig(taskSel,pshuffle)
...
%% accumulate over all the recordings
    ...
    if(exist([pathAnal 'expVarIntAllRecSig.mat']))
        load([pathAnal 'expVarIntAllRecSig.mat']);
    end
    
    
    if(exist('ExpVarAllInt') == 0)
    ...
    save([pathAnal1 'expVarIntAllRecSig' num2str(pshuffle) '.mat'],'ExpVarAllInt','IntRiseExpVar','IntDownExpVar');
