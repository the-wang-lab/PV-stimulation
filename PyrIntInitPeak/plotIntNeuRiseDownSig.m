function plotIntNeuRiseDownSig(pathAnal,timeStepRun,...
            InitAll,IntRise,IntDown,FRProfileMean,FRProfileMeanInt,FRProfileMeanIntStat,colorSel,xlabels)

    for i = 1:max(InitAll.idxC2)
        idxCTmp = find(InitAll.idxC2 == i);
        idxCTmpBad = find(InitAll.idxC2Bad == i);
        
        %% order pyramidal neurons with field based on the peak firing rate after 0
        plotIndFRProfile(timeStepRun,...
                InitAll.avgFRProfileNorm(idxCTmp,:),['FR (Hz)  C' num2str(i)],...
                ['Int_IndFRProfileNormFRPeakAftRunNeuC' num2str(i)],...
                pathAnal,[],5,[],[])

        plotIndFRProfile(timeStepRun,...
                InitAll.avgFRProfileNormBad(idxCTmpBad,:),['FR (Hz) Bad  C' num2str(i)],...
                ['Int_IndFRProfileNormFRPeakAftRunNeuBadC' num2str(i)],...
                pathAnal,[],5,[],[])
        ...
        plotIndFRProfile(timeStepRun,...
                InitAll.avgFRProfileNormBad(idxCTmpBad,:),['FR (Hz) Bad  C' num2str(i)],...
                ['Int_IndFRProfileNormFR0to1VsBefRunNeuBadC' num2str(i)],...
                pathAnal,[],4,FRProfileMean.indFRBefRun,...
                FRProfileMean.indFR0to1) % ordered based on -1to0 to 0to1 mean ratio

        %% average profile good vs bad trials
        plotAvgFRProfileCmp(timeStepRun,...
                InitAll.avgFRProfile(IntRise.idxRise{i},:),...
                InitAll.avgFRProfileBad(IntRise.idxRiseBadBad{i},:),...
                ['FR IntRise Good/Bad C' num2str(i)],...
                ['Int_FRProfileIntRiseGoodBadC' num2str(i)],...
                pathAnal,[0 30],xlabels)
...
%                 pathAnal,[],xlabels)
        ...
        plotAvgFRProfileCmp(timeStepRun,...
                InitAll.avgFRProfileNorm(IntRise.idxRise{i},:),...
                InitAll.avgFRProfileNormBad(IntRise.idxRiseBadBad{i},:),...
                ['FR Norm IntRise Good/Bad C' num2str(i)],...
                ['Int_FRProfileNormIntRiseGoodBadC' num2str(i)],...
                pathAnal,[0 0.85],xlabels)

%         plotAvgFRProfileCmp(timeStepRun,...
%                 InitAll.avgFRProfileNorm(IntDown.idxDown{i},:),...
%                 InitAll.avgFRProfileNormBad(IntDown.idxDownBadBad{i},:),...
%                 ['FR Norm IntDown Good/Bad C' num2str(i)],...
%                 ['Int_FRProfileNormIntDownGoodBadC' num2str(i)],...
%                 pathAnal,[],xlabels)

        plotAvgFRProfileCmp(timeStepRun,...
                InitAll.avgFRProfileNormZ(IntRise.idxRise{i},:),...
                InitAll.avgFRProfileNormZBad(IntRise.idxRiseBadBad{i},:),...
                ['FR NormZ IntRise Good/Bad C' num2str(i)],...
                ['Int_FRProfileNormZIntRiseGoodBadC' num2str(i)],...
        ...
        barPlotWithStat1(1:2,...
                ...
                pathAnal,colorSel,xlabels,[0 2.4]);
