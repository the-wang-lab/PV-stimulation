function mod = PyrModAllRecByTypeAlignedCtrlTr(autoCorrPyrNoCue,autoCorrPyrAL,autoCorrPyrPL,modPyrNoCue,modPyrAL,modPyrPL,autoCorrPyrAll,taskSel,methodKMean)
...
% this function is called by PyrModAllRec_GoodTr.m
    ...
    if(taskSel == 1)
        ...
        %% added on 7/25/2022
        mod.nNeuWithFieldGood = [modPyrNoCue.nNeuWithFieldGood modPyrAL.nNeuWithFieldGood modPyrPL.nNeuWithFieldGood];
        mod.isNeuWithFieldGood = [modPyrNoCue.isNeuWithFieldGood modPyrAL.isNeuWithFieldGood modPyrPL.isNeuWithFieldGood];
        mod.fieldWidthGood = [modPyrNoCue.fieldWidthGood modPyrAL.fieldWidthGood modPyrPL.fieldWidthGood];
        mod.indStartFieldGood = [modPyrNoCue.indStartFieldGood modPyrAL.indStartFieldGood modPyrPL.indStartFieldGood];
        mod.indPeakFieldGood = [modPyrNoCue.indPeakFieldGood modPyrAL.indPeakFieldGood modPyrPL.indPeakFieldGood];
        
        mod.nNeuWithFieldCueGood = [modPyrNoCue.nNeuWithFieldCueGood modPyrAL.nNeuWithFieldCueGood modPyrPL.nNeuWithFieldCueGood];
        mod.isNeuWithFieldCueGood = [modPyrNoCue.isNeuWithFieldCueGood modPyrAL.isNeuWithFieldCueGood modPyrPL.isNeuWithFieldCueGood];
        mod.fieldWidthCueGood = [modPyrNoCue.fieldWidthCueGood modPyrAL.fieldWidthCueGood modPyrPL.fieldWidthCueGood];
        mod.indStartFieldCueGood = [modPyrNoCue.indStartFieldCueGood modPyrAL.indStartFieldCueGood modPyrPL.indStartFieldCueGood];
        mod.indPeakFieldCueGood = [modPyrNoCue.indPeakFieldCueGood modPyrAL.indPeakFieldCueGood modPyrPL.indPeakFieldCueGood];
        %%
        ...
        mod.adaptSpatialInfoCue = [modPyrNoCue.adaptSpatialInfoCue modPyrAL.adaptSpatialInfoCue modPyrPL.adaptSpatialInfoCue];
        mod.spatialInfoCue = [modPyrNoCue.spatialInfoCue modPyrAL.spatialInfoCue modPyrPL.spatialInfoCue];
        mod.sparsityCue = [modPyrNoCue.sparsityCue modPyrAL.sparsityCue modPyrPL.sparsityCue];
    ...
    elseif(taskSel == 2)
        ...
        %% added on 7/25/2022
        mod.nNeuWithFieldGood = [modPyrAL.nNeuWithFieldGood modPyrPL.nNeuWithFieldGood];
        mod.isNeuWithFieldGood = [modPyrAL.isNeuWithFieldGood modPyrPL.isNeuWithFieldGood];
        mod.fieldWidthGood = [modPyrAL.fieldWidthGood modPyrPL.fieldWidthGood];
        mod.indStartFieldGood = [modPyrAL.indStartFieldGood modPyrPL.indStartFieldGood];
        mod.indPeakFieldGood = [modPyrAL.indPeakFieldGood modPyrPL.indPeakFieldGood];
        
        mod.nNeuWithFieldCueGood = [modPyrAL.nNeuWithFieldCueGood modPyrPL.nNeuWithFieldCueGood];
        mod.isNeuWithFieldCueGood = [modPyrAL.isNeuWithFieldCueGood modPyrPL.isNeuWithFieldCueGood];
        mod.fieldWidthCueGood = [modPyrAL.fieldWidthCueGood modPyrPL.fieldWidthCueGood];
        mod.indStartFieldCueGood = [modPyrAL.indStartFieldCueGood modPyrPL.indStartFieldCueGood];
        mod.indPeakFieldCueGood = [modPyrAL.indPeakFieldCueGood modPyrPL.indPeakFieldCueGood];
        %%
        ...
        mod.adaptSpatialInfoCue = [modPyrAL.adaptSpatialInfoCue modPyrPL.adaptSpatialInfoCue];
        mod.spatialInfoCue = [modPyrAL.spatialInfoCue modPyrPL.spatialInfoCue];
        mod.sparsityCue = [modPyrAL.sparsityCue modPyrPL.sparsityCue];
        ...
        %% added on 7/25/2022
        mod.nNeuWithFieldGood = modPyrAL.nNeuWithFieldGood;
        mod.isNeuWithFieldGood = modPyrAL.isNeuWithFieldGood;
        mod.fieldWidthGood = modPyrAL.fieldWidthGood;
        mod.indStartFieldGood = modPyrAL.indStartFieldGood;
        mod.indPeakFieldGood = modPyrAL.indPeakFieldGood;
        
        mod.nNeuWithFieldCueGood = modPyrAL.nNeuWithFieldCueGood;
        mod.isNeuWithFieldCueGood = modPyrAL.isNeuWithFieldCueGood;
        mod.fieldWidthCueGood = modPyrAL.fieldWidthCueGood;
        mod.indStartFieldCueGood = modPyrAL.indStartFieldCueGood;
        mod.indPeakFieldCueGood = modPyrAL.indPeakFieldCueGood;
        %%
        ...
        mod.adaptSpatialInfoCue = modPyrAL.adaptSpatialInfoCue;
        mod.spatialInfoCue = modPyrAL.spatialInfoCue;
        mod.sparsityCue = modPyrAL.sparsityCue;
