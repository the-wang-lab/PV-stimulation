function mod = PyrModAllRecByTypeGoodTr(autoCorrPyrNoCue,autoCorrPyrAL,autoCorrPyrPL,modPyrNoCue,modPyrAL,modPyrPL,autoCorrPyrAll,taskSel,methodKMean)
...
% this function is called by PyrModAllRec_GoodTr.m
    ...
    elseif(taskSel == 2)
        ...
        mod.meanCorrDist = [modPyrAL.meanCorrDist modPyrPL.meanCorrDist];
        mod.meanCorrDistNZ = [modPyrAL.meanCorrDistNZ modPyrPL.meanCorrDistNZ];
        ...
        mod.meanCorrDist = modPyrAL.meanCorrDist;
        mod.meanCorrDistNZ = modPyrAL.meanCorrDistNZ;
